...
- INFORMATION_SCHEMA account views:
  ...
  | LOAD_HISTORY                    | Displays on row for each file loaded into tables using COPY INTO <table> command, and returns history for all data loaded in the part 14 days except for data loaded using Snowpipe. |

- INFORMATION_SCHEMA database views:
  ...
  | SCHEMATA                | Displays one row for each schema in the specified (or current) datase.                                                                                                                                                                                                                                                                                                               |
